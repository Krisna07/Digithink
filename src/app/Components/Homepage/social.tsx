      ...
      <div className="flex gap-4 overflow-x-scroll">
        <div className="min-w-[400px] h-[400px] bg-gray-400 rounded-md relative p-4 box-border bg-clip-padding backdrop-filter backdrop-blur-sm bg-opacity-20 border border-gray-100 shadow-lg flex flex-col gap-2">
          ...
          <div>
            ...
            cum maiores omnis commodi harum modi perferendis iure impedit earum
            voluptas inventore, eius qui eveniet labore dicta doloribus. Velit
            omnis dignissimos repellendus, molestiae temporibus, debitis, unde
            vitae minus reiciendis asperiores quibusdam voluptatum commodi
            ratione veniam provident nam autem ipsam optio nisi!
          </div>
