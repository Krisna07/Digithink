...
const Social = ({ social, classn }: any) => {
  ...
  return (
    <div
      ...
      className="w-full  relative after:w-[60%] after:h-[60%] after:bg-yellow-600 after:absolute after:-top-2 after:-left-2 after:z-[10] "
    >
      <div className="h-full flex flex-col gap-4 items-center relative   box-border shadow-sm bg-white text-black p-4  transition-all hover:scale-[1.05] z-20">
        <div
